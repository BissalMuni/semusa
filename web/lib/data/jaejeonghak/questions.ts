...
가산법: 임금+이자+이윤+감가상각에 세율 적용`,
  ...
  },
  {
    ...
    questionText: `세수함수 T = -400 + 0.5Y 에 관한 설명으로 옳은 것만을 고른 것은? (단, T: 세금, Y(소득) > 800 이다.)`,
    subItems: ["ㄱ. 소득 증가 시 평균세율 증가", "ㄴ. 소득크기에 관계없이 한계세율 일정", "ㄷ. 세수탄력성 < 1", "ㄹ. 한계세율 < 평균세율"],
...
초과부담 작은 조건: 비탄력적 수요/공급`,
  ...
  },
  {
    ...
    subItems: ["ㄱ. 통화주의학파: 경제 불황기에는 호황기에 비해 구축효과가 크게 나타난다.", "ㄴ. 케인즈학파: 국채발행을 통해 재정적자를 충당하면 승수효과만큼 총수요 증가를 가져온다.", "ㄷ. 리카르도(D. Ricardo)의 대등정리: 재정적자를 국채로 충당할 때 총수요에 아무런 영향을 끼치지 않는다.", "ㄹ. 러너(A. Lerner): 내부채무는 미래세대의 부담을 증가시킨다.", "ㅁ. 배로(R. Barro): 적자재정이 국민저축과 투자에 전혀 영향을 미치지 않는다."],
...
균등희생설: 동등절대·동등비례·동등한계희생`,
  ...
  },
  {
    ...
    choices: ["세율 인상에 따른 대체효과는 탈루소득을 줄이는 방향으로 작용한다.", "절대위험기피도가 체감하는 개인은 세율이 오르면 소득효과로 탈루소득의 크기를 줄인다.", "탈세로 인한 심리적 비용이 클수록 탈세 규모는 감소한다.", "절세행위는 불법성을 특징으로 한다는 점에서 조세회피와 구별된다.", "탈세의 편익은 세율로 표현될 수 있으며, 감사받을 확률의 증가나 벌금률의 증가가 탈루소득을 분명하게 늘린다."],
    answer: 3,
...
DARA 가정: 소득↓ 시 위험기피도↑`,
  ...
  },
  {
    ...
    questionText: `한계세율이 소득액 5000만원까지는 10%, 5000만원 초과금액에 대해서는 30%일 때, 두 부부의 소득과 소득세액은 아래와 같다(단, 소득공제는 없다). A부부 — 유○ 0.5억원·이○ 1.5억원, 개인기준 소득세액 각각 500만원·3500만원, 가족기준 소득세액 5000만원. B부부 — 박○ 1억원·전○ 1억원, 개인기준 소득세액 각각 2000만원·2000만원, 가족기준 소득세액 5000만원. 다른 조건이 일정할 때, 두 부부의 과세방식을 개인기준에서 가족기준으로 변경할 경우의 결과로 옳은 것은?`,
...
- 서리(Surrey)가 제안`,
  ...
  },
  {
    ...
    questionText: `이자소득세 부과의 효과에 관한 내용으로 옳은 것의 개수는? (단, 현재소비와 미래소비는 모두 정상재이다.)`,
    subItems: ["저축을 감소시키는 소득효과와 저축을 증가시키는 대체효과를 동시에 발생시킨다.", "저축에 대한 영향은 시점 간 자원배분모형을 이용하여 분석될 수 있다.", "미래소비보다 현재소비가 유리한 여건이 제공될 수 있다.", "현재소비는 대체효과에 의해 증가하고 소득효과에 의해 감소한다.", "민간저축은 증가할 수도 감소할 수도 있다."],
...
- 저축자(lender)의 경우에 해당`,
  ...
  },
  {
    ...
    questionText: `어떤 독점기업의 수요함수는 P = 200 - Q이고, MC는 40이다. 이 때 단위당 60의 종량세를 이 기업에 부과할 경우 발생하는 영향으로 옳지 않은 것은?`,
...
사중손실 증가`,
  ...
  },
  {
    ...
    questionText: `하버거(A. Harberger)는 아래 가정 하에 조세귀착의 일반균형 모형을 분석하였다. 이 경우에 나타나는 현상으로 옳은 것은?`,
    subItems: ["두 재화 X, Y가 있으며, 생산기술은 1차동차(선형동차)이고 X와 Y의 요소집약도는 동일하다.", "모든 시장은 완전경쟁이고 노동과 자본의 부존량은 주어져 있고, 이 생산요소들은 완전한 이동성을 갖는다."],
    choices: ["X부문과 Y부문에 대한 동일 세율의 물품세는 노동의 상대가격을 낮추게 된다.", "X부문에 물품세를 부과하면 노동에 대비한 자본의 상대가격을 높이게 된다.", "X부문의 자본에 대한 과세는 산출효과를 통해 노동에 대비한 자본의 상대가격을 낮추게 된다.", "X부문의 자본에 대한 과세는 요소대체효과를 통해 노동에 대비한 자본의 상대가격을 낮추게 된다.", "Y부문의 노동에 대한 과세 시 산출효과와 요소대체효과는 서로 같은 방향으로 작용한다."],
    answer: 3,
...
노동 귀착 가능성: X가 K집약적일 때`,
  ...
  },
  {
    ...
    subItems: ["ㄱ. 최대부하가격설정에서 비성수기에는 공공요금을 한계비용에 일치시키는 것이 효율적이다.", "ㄴ. 공공부문이 생산하는 재화나 서비스의 한계비용가격설정은 일반적으로 효율적인 자원배분을 실현할 수 없다.", "ㄷ. 공공서비스의 경우 이부가격제도(two-part tariff)를 적용하면 결손을 줄일 수 있다.", "ㄹ. 램지가격설정방식은 분배상 문제를 일으킬 수 있다.", "ㅁ. 규모의 경제가 존재할 경우 여러 공기업에서 생산하는 것이 바람직하다."],
...
정액세: 대체효과 없음, 소득효과만→노동↑(정상재 여가↓)`,
  ...
  },
  {
    ...
    choices: ["자본의 사용자 비용이 적을수록 투자가 증가한다.", "생산요소 간에 대체탄력성이 작으면 자본스톡의 사용자비용탄력성이 낮아질 수 있다.", "자본스톡의 사용자비용탄력성이 작을수록 법인세가 기업의 투자에 미치는 영향이 크다.", "법인세의 경우 자본재 구입비용은 즉시상각하고, 지급이자에 대한 비용공제는 불허하면 투자에 대해 중립적이다.", "자기자본의 귀속이자비용과 차입금에 대한 이자공제가 허용되고 세법상 감가상각률과 경제적 감가상각률이 일치할 경우 법인세는 투자에 영향을 미치지 않는다."],
    answer: 4,
...
실증연구: 사용자비용 변화의 투자 반응은 제한적`,
  ...
  },
  {
    ...
    subItems: ["ㄱ. 자치단체 간 경쟁을 유발하여 효율적인 생산을 촉진한다.", "ㄴ. 중앙정부의 교부금으로 인해 지방의 재정자립도가 높아진다.", "ㄷ. 지역 간 재정능력의 불균형으로 지역 간 격차가 커질 수 있다.", "ㄹ. 오우츠(W. Oates)의 분권화 정리는 지방공공재 공급에 있어서 규모의 경제가 있고, 인접 지역으로의 외부성이 없는 경우에 성립한다.", "ㅁ. 지방분권제도가 중앙집권제도보다 지방공공재에 대한 정보를 획득하는 비용이 높다."],
...
티부(Tiebout)가설: 주민이 선호에 맞는 지역 선택→발로 투표`,
  ...
  },
  {
    ...
    choices: ["후생경제학의 제1정리는 아담 스미스(A. Smith)의 ‘보이지 않는 손’이 효율적인 자원배분을 실현함을 의미한다.", "정보의 비대칭성은 자원배분의 비효율성을 초래하는 요인이 된다.", "어떤 자원배분 상태에 파레토개선의 여지가 있다면 그 상태는 효율적이다.", "영기준 예산제도는 점증주의 예산에서 탈피하여 효율적 자원배분을 제고할 수 있는 제도이다.", "공공부문이 공급하는 재화나 서비스에 공공요금을 부과하면 가격기능을 통해 효율적인 자원배분이 가능하다."],
    answer: 3,
...
제2후생정리: 파레토효율→재분배+경쟁으로 달성 가능`,
  ...
  },
  {
    ...
    questionText: `A와 B 두 명으로 구성된 사회에서 개인의 효용을 각각 U_A와 U_B, 사회후생을 W라고 할 때, 다음 중 옳지 않은 것은?`,
    choices: ["어떤 배분상태가 효용가능경계상에 있다면 그 상태에서 효율성과 공평성을 동시에 개선시킬 수 없다.", "평등주의적 사회후생함수의 경우, 평등주의적 성향이 극단적으로 강하면 롤즈(J. Rawls)적 사회무차별곡선의 형태를 가진다.", "롤즈의 사회후생함수는 W = min[U_A, U_B]로 나타낼 수 있다.", "사회후생함수가 W = U_A + 2U_B일 경우, B의 효용이 A의 효용보다 사회적으로 2배의 중요성이 부여되고 있다.", "평등주의적 사회후생함수는 사회 구성원들에게 동일한 가중치를 부여한다."],
    answer: 4,
...
정부실패: 정보부족, 관료이기심, 정치적 압력, 시차`,
  ...
  },
  {
    ...
    questionText: `기업 A와 B는 현재 각각 500단위의 오염을 배출하고 있으며, 배출의 저감비용은 각각 C(q_A) = 40 + ½q_A², C(q_B) = 30 + q_B²이다. 정부가 총 배출량을 30% 줄이기 위해 배출권거래제를 도입하고, A에 400단위, B에 300단위의 배출권을 무료로 할당한다면 배출권시장의 균형에서 (ㄱ)배출권의 가격과 (ㄴ)배출권 거래량은? (단, q_i(i=A, B)는 기업 i의 배출 저감량이다.)`,
...
차이: 피구세는 가격 고정, 배출권은 수량 고정`,
  ...
  },
  {
    ...
    questionText: `개인 A와 B로 구성된 경제에 X재가 1000단위 존재하며, 이 재화에 대한 효용함수는 각각 U_A = 3√(X_A), U_B = √(X_B)이다. 이 사회의 사회후생함수를 W = min{U_A, U_B}로 가정할 경우 사회후생의 극댓값은? (단, X_i > 0 (i=A, B)는 개인 i의 X재 소비량이다.)`,
...
코즈정리 한계: 거래비용, 다수당사자, 정보비대칭`,
  ...
  },
  {
    ...
    choices: ["클럽재는 부분적으로 경합성의 성질을 가져 혼잡을 발생시키는 재화나 서비스이다.", "순수공공재의 경우 소비자 추가에 따른 한계비용이 영(0)이다.", "공공재의 최적 공급수준은 개별 이용자의 한계편익의 합과 한계비용이 일치할 때 달성된다.", "클라크 조세(Clarke tax)에서 각 개인은 공공재에 대한 자신의 진정한 선호를 표출하는 것이 우월전략이다.", "가치재는 순수 공공재에 해당된다."],
    answer: 3,
...
클라크세(Clarke tax): 선호 표출 유인 부여`,
  ...
  },
  {
    ...
    choices: ["과반수제가 갖는 문제점으로는 투표의 역설이 있다.", "최적다수결제의 경우 의사결정비용은 의결에 필요한 표수가 클수록 커진다.", "린달(E. Lindahl) 모형은 전원합의제에 의한 공공재 배분의 가능성을 보여준 사례이다.", "전략적 행동이 없을 경우, 선택대상에 대한 선호의 강도를 가장 잘 반영하는 것은 점수투표제이다.", "점수투표제에서 투표거래(logrolling)가 발생하면 선호의 강도가 반영될 수 없다."],
    answer: 4,
...
ㅇ 화살불가능성정리: 민주적 사회선택규칙 불가능`,
  ...
  },
  {
    ...
    choices: ["배출권 시장의 균형에서는 개별 기업이 결정한 배출량의 합이 정부가 설정한 목표 배출량과 일치한다.", "정부는 총배출량을 설정할 때 개별 기업의 한계저감비용에 관한 정보를 필요로 한다.", "환경세에 비해 인플레이션과 같은 경제 상황의 변화에 쉽게 적응할 수 있다.", "배출권 거래 시 한계저감비용이 상대적으로 높은 기업이 구매자가 된다.", "배출권 시장의 균형에서는 각 기업의 한계저감비용이 같아진다."],
    answer: 2,
...
불확실성 하: 와이츠만(Weitzman) 분석`,
  ...
  },
  {
    ...
    choices: ["관료는 사회적 최적 수준보다 과다한 생산 수준을 선택한다.", "생산 수준이 미그-빌레인저(Migue-Belanger) 모형에서 제시한 수준보다 더 적다.", "관료제에 대응하는 방안으로 민간부문에 생산을 맡기고 정부는 비용만 부담하는 방법을 제안했다.", "관료가 선택한 생산수준에서는 사회적 잉여가 영(0)이다.", "관료는 예산 극대화를 추구하며, 총편익과 총비용이 일치하는 수준에서 생산 수준을 결정한다."],
    answer: 4,
...
X비효율: 독점적 지위→비용절감 유인 부족`,
  ...
  },
  {
    ...
    choices: ["공공사업을 추진하는 행정주체는 내부적 편익과 외부적 편익 가운데 외부적 편익을 더 중시한다.", "공공사업의 목표는 소득재분배, 총 소비 증대를 통한 국민의 후생증진에 국한된다.", "공공사업에서 발생하는 금전적 편익은 사회 전체적인 후생을 증진시킨다.", "공공사업의 유형적 편익과 무형적 편익을 비교하면 무형적 편익이 크다.", "공공사업은 이윤 이외의 목표 추구 등을 고려하므로 그 편익과 비용을 측정할 때 시장가격과 다른 척도의 적용이 필요하다."],
    answer: 3,
...
할인율: 사회적할인율 사용(시장이자율과 다를 수 있음)`,
  ...
  },
  {
    ...
    subItems: ["ㄱ. 교육기회 확대", "ㄴ. 누진세제", "ㄷ. 인두세 강화", "ㄹ. 복권제도 활성화"],
...
- 역진적 간접세: 필수품 과세`,
  ...
  },
  {
    ...
    choices: ["사회후생함수에 의한 가치판단을 명시적으로 전제하여 소득불평등을 측정한다.", "불균등한 분배가 사회후생을 떨어뜨리는 정도가 클수록 균등분배대등소득과 1인당 평균소득 간 격차는 줄어든다.", "균등분배대등소득과 1인당 평균소득이 같으면 앳킨슨 지수는 영(0)의 값을 갖는다.", "동일한 분배상태라도 보는 사람에 따라 균등분배대등소득이 달라질 수 있으므로 앳킨슨 지수의 값은 여러 가지로 측정될 수 있다.", "앳킨슨 지수는 0에서 1 사이의 값을 갖는다."],
    answer: 4,
...
로렌츠 비교와 달리 완전 순서화 가능`,
  ...
  },
  {
    ...
    subItems: ["ㄱ. 정부의 재정수입 달성", "ㄴ. 시장실패의 보완", "ㄷ. 보험료에 의한 재원 조달", "ㄹ. 정부의 온정적 간섭주의"],
...
ㄹ 온정적 간섭→가치재 공급 근거, 사회보험과 관련`,
  ...
  },
  {
    ...
    questionText: `다음은 예산제도에 관한 설명이다. ( )에 들어갈 내용으로 옳은 것은? 각 기관의 지출항목별로 예산을 편성하는 방식을 ( ㄱ )라고 부른다. ( ㄱ )는 유사한 일을 하는 부서 간에 예산편중 중복을 차단하기 쉽지 않다. ( ㄴ )는 비슷한 기능을 가진 부서들이 하는 업무를 하나로 묶어 소요예산을 절감하는 방식을 따르며, 우리나라는 2007년부터 도입하여 운영하고 있다.`,
    choices: ["ㄱ: 품목별 예산제도, ㄴ: 영기준 예산제도", "ㄱ: 품목별 예산제도, ㄴ: 프로그램 예산제도", "ㄱ: 영기준 예산제도, ㄴ: 품목별 예산제도", "ㄱ: 프로그램 예산제도, ㄴ: 품목별 예산제도", "ㄱ: 영기준 예산제도, ㄴ: 프로그램 예산제도"],
    answer: 4,
...
NPB(신성과주의): 산출·성과 중심+재량 부여`,
  ...
  },
  {
    ...
    choices: ["롤즈(J. Rawls)의 가치판단에 기초한 사회무차별곡선은 우하향하는 직선 형태로 표시된다.", "사회후생함수가 설정되면 어떤 변화가 발생했을 때, 그것이 개선인지의 여부를 판정할 수 있다.", "사회후생함수와 효용가능경계를 이용하여 바람직한 자원배분을 도출할 수 있다.", "사회구성원들의 가치판단에 따라 여러 유형의 사회후생함수가 선택될 수 있다.", "센(A. Sen)에 따르면 제한된 수의 선택가능성 사이에 서열을 매길 수 있는 합리적이고 민주적인 사회적 선호체계의 도출이 가능하다."],
    answer: 2,
...
사회보험: 보험료+급여 연계`,
  ...
  },
  {
    ...
    choices: ["브라운-잭슨(C. Brown & P. Jackson): 바그너(A. Wagner)의 법칙을 중위투표자의 선택과 결부시켜 설명하였다.", "보몰(W. Baumol): 사회적 격변기에 전위효과(displacement effect)의 영향으로 정부지출이 팽창된다고 보았다.", "피코크-와이즈만(A. Peacock & J. Wiseman): 노동집약적인 공공부문이 민간부문보다 생산성 향상이 느리기 때문에 정부지출이 팽창된다고 주장하였다.", "부캐넌(J. Buchanan): 정부지출의 편익이 간접적으로 인식되는 반면, 공공서비스의 공급비용은 과대평가되므로 정부지출이 팽창된다고 설명하였다.", "바그너의 법칙: 1인당 국민소득 하락 국면에서 공공부문의 상대적 크기가 증가하는 것을 말한다."],
    answer: 2,
...
톱니효과(ratchet): 위기 후에도 높은 수준 유지`,
  ...
  },
  {
    ...
    choices: ["파레토기준을 충족한 투자계획만을 채택한다.", "공공부문의 투자계획 타당성 판정에만 적용된다.", "현재가치법에서 적용되는 할인율은 투자계획에 사용되는 자금의 기간당 기회비용과 일치하도록 선택되어야 한다.", "현재가치법은 어떤 투자계획의 채택가능성을 평가할 뿐이며, 투자계획들 간 우선순위를 결정하지는 못한다.", "내부수익률이 투자계획에 소요되는 자금의 기회비용인 할인율보다 크다면 그 투자계획은 기각된다."],
    answer: 4,
...
기펜재: 열등재+소득효과 압도→수요법칙 위배`,
  ...
  },
  {
    ...
    questionText: `단위당 생산비가 57원으로 일정한 독점기업에게 판매단위당 9원의 판매세를 부과한다고 하자. 시장수요곡선이 우하향하는 직선일 때, 독점기업이 부담하는 단위당 판매세에 관한 설명으로 옳은 것은?`,
...
수요↑+공급↓: P↑ 확실, Q 불확실`,
  ...
  },
  {
    ...
    questionText: `수요함수가 Q = 120 - 2P이고 공급함수가 Q = P인 완전경쟁시장을 고려하자. 정부가 단위당 12원의 물품세를 소비자에게 부과할 때, 그 중 생산자의 부담액은?`,
...
⑤재화정의 범위: 좁을수록 탄력적`,
  ...
  },
  {
    ...
    choices: ["우리나라의 현행 법인세 최고세율은 22%이다.", "인플레이션이 있을 경우 감가상각공제의 현재가치는 증가하므로 법인세 부담은 감소하게 된다.", "자기자본에 대한 귀속이자를 경비로 인정해 주지 않는 법인세제상의 특성이 법인들로 하여금 유상증자에 대한 의존도를 높이는 유인이 될 수 있다.", "법인세가 경제적 이윤에 대한 과세가 되기 위해서는 당기순이익이 경제적 이윤보다 커야 한다.", "법인세가 이윤에 대한 과세의 성격을 가지게 되는 경우에는 그 부담은 소유주인 주주에게 귀착된다."],
    answer: 4,
...
MRS = MU_x/MU_y = P_x/P_y`,
  ...
  },
  {
    ...
    choices: ["다른 조건이 일정할 때 인플레이션으로 명목소득이 증가하게 되면 소득세 부담은 감소하게 된다.", "개인소득세는 가구단위가 아닌 개인단위로 부과하고 있다.", "부가가치세는 최종단계의 부가가치에만 과세되어 수직적 통합을 방지하는 효과가 있다.", "비례소득세는 수직적 공평성을 개선하게 된다.", "이자소득세를 부과할 경우, 소득효과는 저축의욕을 떨어뜨린다."],
    answer: 2,
...
α+β<1: 규모수익 체감`,
  ...
  },
  {
    ...
    subItems: ["ㄱ. 남북협력기금에 대한 보조금 지급", "ㄴ. 법인세 특별감가상각", "ㄷ. 조세수입으로 확보된 재정의 지출", "ㄹ. 투자세액공제", "ㅁ. 공해배출기업에 대한 환경세 부과", "ㅂ. 기부행위에 대한 소득공제"],
...
비용체감산업→우하향`,
  ...
  },
  {
    ...
    subItems: ["ㄱ. 자원배분의 왜곡 초래", "ㄴ. 지하경제 비대", "ㄷ. 조세부담의 불공평 초래", "ㄹ. 경제정책 효과의 불확실 초래"],
...
3급: 시장별 다른 가격→|Ed|높은시장 낮은가격`,
  ...
  },
  {
    ...
    choices: ["여가가 정상재일 경우 소득효과가 대체효과보다 크면 후방굴절형 노동공급곡선이 될 것이다.", "여가가 정상재일 경우 비례소득세 부과로 인한 소득효과가 대체효과보다 작다면 노동공급은 줄어든다.", "여가가 정상재일 경우 누진소득세 부과가 노동공급에 미치는 영향은 비례소득세 부과와 유사하지만 고소득자에게 유리하다.", "여가가 열등재일 경우 비례소득세를 부과하면 노동공급은 감소한다.", "여가가 열등재일 경우 정액세(lump-sum tax)를 부과하면 소득효과만 존재하여 노동공급은 감소한다."],
    answer: 1,
...
반복게임: 협조 가능성↑(무한반복+충분한 할인요소)`,
  ...
  },
  {
    ...
    questionText: `시점간(inter-temporal) 소비선택 모형에서 이자소득세의 부과에 관한 설명으로 옳은 것은? (단, 무차별곡선은 원점에 대해 강볼록하며, 미래소득은 영(0)이다. 그리고 현재소비와 미래소비는 모두 정상재이다.)`,
...
법적 납세의무자와 무관(비법정 귀착)`,
  ...
  },
  {
    ...
    subItems: ["ㄱ. 투자수익에 조세가 부과되지 않으면 한계실효세율은 0이다.", "ㄴ. 한계실효세율이 낮을수록 투자에 유리하다.", "ㄷ. 한계실효세율이 음(-)인 경우, 조세가 투자를 촉진하는 결과를 가져온다."],
...
효율성, 공평성, 경제안정, 행정편의`,
  ...
  },
  {
    ...
    questionText: `자본의 사용자 비용(user cost of capital)을 낮추어 투자를 촉진할 수 있는 조세정책이 아닌 것은?`,
...
독점: 수요곡선 형태(볼록/오목)에 크게 의존`,
  ...
  },
  {
    ...
    subItems: ["ㄱ. 이 명제는 기업의 가치를 극대화하는 최적 자본구조의 존재를 증명한 것이다.", "ㄴ. 이 명제에서는 기업의 수익에 조세가 과세되지 않는 것을 가정하고 있다.", "ㄷ. 이 명제에서는 경영자가 주주의 재산을 극대화하려는 노력을 가정하고 있다.", "ㄹ. 이 명제에서는 모든 투자자와 경영자가 같은 정보를 가지고 있음을 가정하고 있다."],
...
→최적 오염수준 자발적 달성`,
  ...
  },
  {
    ...
    questionText: `재정정책의 경제적 효과에 관한 설명으로 옳은 것은?`,
...
대안: 수요표출 메커니즘(클라크세, VCG)`,
  ...
  },
  {
    ...
    choices: ["규모의 경제가 존재하는 경우 하나의 공기업에서 생산하는 것이 더 낮은 비용으로 생산할 수 있다.", "민간기업이 생산하고 가격규제를 하지 않으면 사회적 최적생산량 달성이 가능하다.", "공공서비스의 경우 이부가격제도(two-part tariff)를 적용하면 결손을 줄일 수 있으나, 효율적 생산량에 도달하는 것은 불가능하다.", "한계비용가격설정을 사용하는 경우 해당 공기업의 경제적 이윤은 양(+)이 된다.", "평균비용가격설정을 사용하는 경우 해당 공기업의 경제적 이윤은 음(-)이 된다."],
    answer: 3,
...
결론: U+P+I+D를 동시 만족하는 사회적 선호순서 불가능`,
  ...
  },
  {
    ...
    questionText: `독점적으로 가스를 공급하는 K가스공사는 동일 비용으로 가스를 생산하여 가정용과 산업용으로 구분하여 판매하고 있다. 산업용 가스의 시장수요의 가격탄력성은 3이고, 가정용 가스의 시장수요의 가격탄력성은 2라고 한다. 가정용 가스의 m³당 가격이 1,200원이라면 K가스공사가 이윤을 극대화할 수 있는 산업용 가스의 m³당 가격은? (단, 기타 비용은 0원이다.)`,
...
④소득효과→재산권 귀속이 효율에도 영향 가능`,
  ...
  },
  {
    ...
    choices: ["지방세 규모는 국세 규모보다 작다.", "중앙정부는 법률로 국세를 신설할 수 있으며 지방자치단체는 법률에 관계없이 조례로 지역에 필요한 지방세목을 신설할 수 있다.", "지방재정조정제도에서 조정교부금제도는 상위지방자치단체가 하위지방자치단체에 지원하는 제도이다.", "지방교부세는 재원의 사용 용도가 정해져 있지 않다.", "부동산 경기변동은 지방재정의 규모와 안정성에 영향을 주게 된다."],
    answer: 2,
...
IS수평: 재정무효, 통화최대`,
  ...
  },
  {
    ...
    choices: ["지방분권의 정도를 간접적으로 파악할 수 있는 중앙집권화율은 중앙정부의 지출을 지방정부의 지출로 나누어 계산한다.", "지방자치단체 간의 경쟁을 촉진하여 공공서비스의 효율적인 생산을 유도한다.", "티부(C. Tiebout) 모형은 공공재 공급의 재원으로 재산세를 상정하고 있다.", "중앙집권제도에 비해 공공재와 세금에 대한 정보확보비용이 증가하게 된다.", "오우츠(W. Oates)에 의하면 공공재 공급비용이 동일하다면 지방공공재는 지방정부가 공급하는 것이 효율적이다."],
    answer: 4,
...
공급측: 규제완화, 기술개발→AS우이동`,
  ...
  },
  {
    ...
    questionText: `소득세율이 소득구간에 따라 0원에서 1,200만원까지는 0%, 1,200만원 초과 3,000만원까지는 9%, 3,000만원 초과 5,000만원까지는 18%, 5,000만원 초과부터는 27%이다. K군의 총소득 5,500만원에서 각종 공제를 적용한 후 과세가능소득은 4,500만원이다. K군의 (A)한계세율과 (B)실효세율은? (단, 백분율(%)을 구할 때 소수점 셋째 자리에서 반올림한다.)`,
...
단기: APC>MPC(케인즈 퍼즐 해결)`,
  ...
  },
  {
    ...
    questionText: `두 소비자 1과 2가 두 재화 x와 y를 소비하는 순수교환경제를 고려하자. 소비자 1의 부존은 (18, 12), 소비자 2의 부존은 (22, 8)이며, 소비자 i의 효용함수는 u_i(x_i, y_i) = x_i·y_i라 하자(i = 1, 2). 다음의 배분 ((x_1, y_1), (x_2, y_2)) 중 파레토 개선이 가능하지 않은 것을 모두 고르면?`,
    subItems: ["ㄱ. ((6, 3), (34, 17))", "ㄴ. ((16, 8), (22, 11))", "ㄷ. ((24, 10), (16, 10))", "ㄹ. ((38, 19), (2, 1))"],
...
규제포획이론: 규제기관이 피규제자에 포획`,
  ...
  },
  {
    ...
    questionText: `두 사람으로 구성된 어느 경제의 효용가능경계와 사회후생함수 W_A = U_1 + U_2의 사회무차별곡선과의 접점을 A, 사회후생함수 W_B = min{U_1, U_2}의 사회무차별곡선과의 접점을 B, 사회후생함수 W_C = U_1·U_2의 사회무차별곡선과의 접점을 C라고 하자. 이 접점들이 각 경우에 유일한 접점이라고 하자. 다음 중 옳은 것을 모두 고른 것은?`,
    subItems: ["ㄱ. A와 B가 일치하면 C도 반드시 일치한다.", "ㄴ. A와 C가 일치하면 B도 반드시 일치한다.", "ㄷ. B와 C가 일치하면 A도 반드시 일치한다.", "ㄹ. 세 접점이 모두 일치할 수는 없다."],
...
EU(전략1)=EU(전략2)에서 혼합확률 도출`,
  ...
  },
  {
    ...
    subItems: ["ㄱ. 제1정리는 완전경쟁시장에서 개인의 이기적인 선택의 결과가 사회적 관점에서도 효율적인 자원배분을 이루어낸다는 것을 의미한다.", "ㄴ. 제2정리는 효율성이 공평한 자원배분을 보장한다는 의미를 갖는다.", "ㄷ. 후생경제학의 제1정리와 제2정리의 결론은 소비자 선호의 볼록성과 무관하게 성립한다."],
...
규모의경제: LAC↓, 내부규모의경제(기술적)+외부규모의경제(산업적)`,
  ...
  },
  {
    ...
    questionText: `긍정적 외부성이 있는 양봉업자가 생산하는 벌꿀에 대한 수요함수가 Q = 10 - 2P이고, 외부한계편익함수는 Q = 5 - 2P이다. 한계생산비용이 4라면 사회적 최적 생산량은?`,
...
IS-LM에서는 이자율 변화로 승수 축소(구축효과)`,
  ...
  },
  {
    ...
    subItems: ["ㄱ. 시장실패는 정부개입의 충분조건이다.", "ㄴ. 자연독점에 대한 평균비용가격설정은 독점으로 인한 비효율을 제거할 수 있다.", "ㄷ. 정액세(lump-sum tax)는 민간부문의 의사결정을 왜곡하지 않는다.", "ㄹ. 사회보험은 시장실패를 보완하는 기능을 수행한다.", "ㅁ. 공공재는 배제성과 경합성의 특성으로 인하여 시장실패가 발생하게 된다."],
...
로렌츠 지배: 곡선 교차 없이 한쪽이 완전히 안쪽→불평등`,
  ...
  },
  {
    ...
    questionText: `9명의 투표자 중 A유형은 4명, B유형은 3명, C유형은 2명이며, 이들은 네 개의 대안 a, b, c, d를 놓고 선택하고자 한다. 각 유형의 대안에 대한 선호는 다음과 같다고 하자. 보다(Borda)투표제를 실시한다면, 어느 대안이 선택되겠는가? (단, 선호 조작은 없다고 가정한다.) A유형(4명): a≻b≻c≻d, B유형(3명): b≻d≻a≻c, C유형(2명): c≻d≻b≻a`,
    choices: ["a", "b", "c", "d", "투표 결과를 특정할 수 없다."],
    answer: 3,
...
→효용가능경계가 교차할 때 발생`,
  ...
  },
  {
    ...
    subItems: ["ㄱ. 5분위분배율", "ㄴ. 10분위분배율", "ㄷ. 지니계수", "ㄹ. 앳킨슨지수", "ㅁ. 달튼지수"],
...
MAC 완만+MD 급경사 → 수량규제(배출권) 유리`,
  ...
  },
  {
    ...
    questionText: `세 투표자 A, B, C가 세 가지 대안 a, b, c에 대하여 다음과 같은 선호를 가지고 있다고 할 때, 꽁도세 승자(Condorcet winner)는? (단, 선호 조작은 없다고 가정한다.) A: a≻b≻c, B: b≻c≻a, C: c≻b≻a`,
    choices: ["a", "b", "c", "a, b, c", "투표의 역설로 꽁도세 승자는 존재하지 않는다."],
    answer: 3,
...
비판: 관료 동기 다양, 의회의 정보수집 능력`,
  ...
  },
  {
    ...
    questionText: `작은 섬나라 '율도국'에는 해안과 내륙지역에 각각 6명, 4명의 주민이 거주하고 있는데, 정부는 지진해일(Tsunami) 경보서비스를 제공하고 있다. 해안지역 주민의 개별수요함수는 Q = 100 - ½P, 내륙지역 주민의 개별수요함수는 Q = 50 - ⅓P로 표현된다. 경보서비스의 한계비용이 840일 때, 사회적으로 바람직한 경보서비스 수준과 해안과 내륙지역 주민 1명이 각각 부담해야 할 몫은? (단, Q는 경보서비스 수준, P는 주민부담몫이다.)`,
    choices: ["경보서비스 수준은 40, 해안지역 주민은 120, 내륙지역 주민은 30", "경보서비스 수준은 40, 해안지역 주민은 126, 내륙지역 주민은 42", "경보서비스 수준은 40, 해안지역 주민은 140, 내륙지역 주민은 0", "경보서비스 수준은 50, 해안지역 주민은 60, 내륙지역 주민은 40", "경보서비스 수준은 50, 해안지역 주민은 126, 내륙지역 주민은 42"],
    answer: 2,
...
- 소득세 존재 시: 코렛-헤이그(여가 보완재에 높은 세율)`,
  ...
  },
  {
    ...
    questionText: `최적분배에 관한 설명으로 옳지 않은 것은?`,
    choices: ["공리주의적 견해에 의하면 바람직한 분배란 그 사회의 총체적 후생을 극대화할 수 있는 분배이어야 한다.", "평등주의적 견해에 의하면 모든 사람에게 평등하게 분배하는 것이 정의롭다.", "롤즈(J. Rawls)는 사회의 가장 가난한 사람의 후생을 극대화하도록 분배하는 것이 그 사회의 후생을 극대화하는 것이라 하였다.", "자유주의적 견해에 의하면 정부의 간섭 없이 자유로운 시장의 힘에 의해 결정된 분배상태가 가장 바람직하다.", "러너(A. Lerner)에 의하면 사람들의 효용함수가 서로 다르면 동등확률 하에서도 균등분배는 최적이 될 수 없다."],
    answer: 4,
...
달톤: I=1-W_실제/W_균등 (공리주의 SWF)`,
  ...
  },
  {
    ...
    choices: ["차상위계층이라 함은 소득이 최저생계비 130% 이하인 가구를 말한다.", "기초연금제도 운영에 필요한 재원은 국민연금 보험료로 충당한다.", "국민기초생활보장제도 수급자로서 급여를 받기 위해서는 부양의무자가 없거나 있어도 부양이 불가능하여야 하며, 자산조사 결과 최저생계비 이하이어야 한다.", "사업장(직장)가입자의 모든 사회보험료는 고용주와 근로자가 각각 절반씩 분담한다.", "건강보험제도 운영에 필요한 재원은 가입자 및 사용자로부터 징수한 보험료와 정부지원금으로 충당한다."],
    answer: 3,
...
크림스키밍: 보험자가 저위험자만 선택→공적보험 필요`,
  ...
  },
  {
    ...
    choices: ["현물보조가 현금보조에 비하여 정책목적 달성에 효율적이다.", "현물보조 대상은 주로 해당 현물의 소비가 바람직하다고 생각하는 가치재들이다.", "현물보조는 현금보조에 비하여 높은 행정비용과 운영비용을 수반한다.", "생산에서 규모의 경제가 성립하는 재화는 현물보조가 더 효율적이다.", "동일한 재정을 투입하는 경우 일반적으로 현물보조가 현금보조에 비하여 소비자 만족도가 높다."],
    answer: 2,
...
지방소비세·지방소득세: 국세와 연계`,
  ...
  },
  {
    ...
    choices: ["우리나라에서 시행 중인 사회보험은 연금보험, 건강보험, 산재보험, 고용보험, 노인장기요양보험으로 5가지이다.", "사회보험제도의 도입으로 역선택을 방지할 수 있다.", "우리나라 의료보장제도는 국민보건서비스 방식이다.", "사회보험제도의 운영에 필요한 재원조달방식에는 적립방식과 부과방식의 두 가지가 있다.", "국민연금은 현금급여, 건강보험은 현물급여가 원칙이다."],
    answer: 1,
...
발생주의: 거래발생시점 인식(현금주의: 현금수수시점)`,
  ...
  },
  {
    ...
    choices: ["일반국민이 가입하는 국민연금과 공무원, 군인, 사립학교 교직원이 가입하는 직역연금으로 구분된다.", "국민연금은 기여원칙에 따른 적립방식을 채택하고 있으나 완전적립방식이 아니어서 세대내 재분배효과뿐만 아니라 세대간 재분배효과도 발생한다.", "국민연금은 18세 이상 60세 미만으로 대한민국 국민이면 국외거주자도 가입할 수 있다.", "국민연금의 연금급여에는 노령연금, 장애연금, 유족연금이 있다.", "국민연금 보험료는 기준소득월액에 보험료율을 곱하여 산정한다."],
    answer: 4,
...
GDP디플레이터 = 명목GDP/실질GDP × 100`,
  ...
  },
  {
    ...
    questionText: `한 국가의 민간소비(C), 조세(T), 정부지출(G), 투자(I)가 아래와 같고 재정은 균형상태이며 완전고용국민소득은 7,000이다. 정부지출과 조세를 통해서 국민소득을 조정하고자 할 경우에 관한 설명으로 옳지 않은 것은? (단, Y는 국민소득이다.) C = 1,000 + 0.6(Y - T), G = 1,000, I = 1,000`,
    choices: ["완전고용 달성에 필요한 조세의 감소규모는 600이다.", "완전고용 달성에 필요한 정부지출의 증가액은 400이다.", "정부지출 증가 시에 정부지출의 증가액보다 국민소득이 더 많이 증가한다.", "조세 감세 시에 조세의 감세액보다 국민소득의 증가액이 더 크다.", "경기침체 등으로 민간의 한계소비성향이 줄어들게 되면 정부지출이 유발하는 국민소득의 증가분은 줄어들게 된다."],
    answer: 2,
...
- 인플레이션·운용 위험`,
  ...
  },
  {
    ...
    choices: ["바그너(A. Wagner) 법칙에 의하면, 1인당 소비가 증가할 때 국민소득에서 차지하는 공공부문은 민간부문에 비례하여 성장한다.", "보몰효과(Baumol effect)에 의하면, 정부가 생산·공급하는 서비스의 생산비용이 상대적으로 낮아지면 정부지출이 증가하게 된다.", "부캐넌(J. Buchanan)은 현대의 대의민주체제가 본질적으로 정부부문의 팽창을 억제한다는 리바이어던 가설(Leviathan hypothesis)을 제기하였다.", "피코크-와이즈만(A. Peacock & J. Wiseman)에 의하면, 사회적 혼란기에는 전위효과(displacement effect)에 의하여 정부지출이 증가하게 된다.", "브라운-잭슨(C. Brown & P. Jackson)에 의하면, 중위투표자의 공공서비스에 대한 수요의 소득탄력성이 줄어들게 되면 정부지출의 비중이 증가하게 된다."],
    answer: 3,
...
리바이어던: 정부=세입극대화 괴물(뷰캐넌)`,
  ...
  },
  {
    ...
    choices: ["사회적인 할인율이 높아질수록 초기에 편익이 집중되는 사업이 유리하다.", "불완전경쟁시장에서는 재화의 시장가격이 기회비용을 적절히 반영하지 못하므로 잠재가격을 사용한다.", "공공사업으로 시장가격이 낮아지는 경우라면 증가된 소비자잉여가 편익에 포함되어야 한다.", "시장이자율이 사회적 할인율보다 높을 때 시장이자율을 할인율로 사용하면 공공사업의 경제성이 커질 수 있다.", "공공사업에서 발생하는 무형의 편익에 대한 평가가 매우 힘든 경우 비용효과분석(cost-effectiveness analysis)을 이용할 수 있다."],
    answer: 1,
...
시장이자율과 다를 수 있음`,
  ...
  },
  {
    ...
    choices: ["노동 자체로부터 만족을 얻는 사람의 시간가치는 임금률보다 더 높을 수 있다.", "현재의 임금률로 더 일하고 싶어도 할 수 없는 사람의 시간가치는 임금률보다 더 높을 것이라 추정할 수 있다.", "서로 다른 시간이 소요되는 교통수단에 지불되는 요금의 차이를 이용하여 시간의 가치를 추정할 수 있다.", "사망확률을 낮추기 위하여 지불할 용의가 있는 금액으로 생명의 가치를 평가하는 방법은 생명의 가치를 과소평가할 가능성이 있다.", "사망에 따른 소득상실액으로 생명의 가치를 평가하는 방법은 노인이나 장애인의 생명가치를 적절히 평가하지 못하는 한계가 있다."],
    answer: 4,
...
소득소비곡선: 가격 고정, 소득 변화→최적점 이동 궤적`,
  ...
  },
  {
    ...
    questionText: `커피우유의 수요함수와 공급함수가 각각 Qd = 50 - 2P, Qs = 3P - 20이다. 정부가 단위당 10원의 물품세를 생산자에게 부과하는 경우, 다음 설명으로 옳지 않은 것은?`,
...
규모수익: 모든 투입 n배→산출 변화`,
  ...
  },
  {
    ...
    subItems: ["ㄱ. 능력원칙 ㄴ. 중립성 원칙 ㄷ. 효율성 원칙", "ㄹ. 편익원칙 ㅁ. 최소징세비 원칙", "ㄱ. 능력원칙 ㄴ. 중립성 원칙 ㄷ. 효율성 원칙", "ㄹ. 편익원칙 ㅁ. 최소징세비 원칙"],
...
장기공급곡선: 비용불변→수평, 비용체증→우상향`,
  ...
  },
  {
    ...
    subItems: ["ㄱ. 자본이득방식(capital gains method) - 법인세를 폐지하고 실현여부와 관계 없이 모든 자본이득에 소득세를 부과하는 방식으로 부분통합에 해당된다. ㄴ. 조합방식(partnership method) - 배당이나 사내유보를 구분하지 않고 법 인의 이윤을 모두 주주에게 귀속시켜 개인소득세로 부과하는 방식으로 완 전통합에 해당된다.", "ㄷ. 배당세액공제제도(dividend gross-up method) - 법인의 모든 이윤에 대해 법인세를 부과한 다음, 법인세 중 배당부분에 해당하는 금액을 개인소득세 에서 세액공제해주는 방식으로 완전통합에 해당된다.", "ㄹ. 차등세율제도(split rate system) - 법인의 이윤 중 배당금으로 지급되는 부분에 대해서는 사내유보가 되는 부분보다 더 낮은 법인세율을 적용해주 는 방식으로 부분통합에 해당된다.", "ㄱ. 자본이득방식(capital gains method) - 법인세를 폐지하고 실현여부와 관계 없이 모든 자본이득에 소득세를 부과하는 방식으로 부분통합에 해당된다. ㄴ. 조합방식(partnership method) - 배당이나 사내유보를 구분하지 않고 법 인의 이윤을 모두 주주에게 귀속시켜 개인소득세로 부과하는 방식으로 완 전통합에 해당된다.", "ㄷ. 배당세액공제제도(dividend gross-up method) - 법인의 모든 이윤에 대해 법인세를 부과한 다음, 법인세 중 배당부분에 해당하는 금액을 개인소득세 에서 세액공제해주는 방식으로 완전통합에 해당된다.", "ㄹ. 차등세율제도(split rate system) - 법인의 이윤 중 배당금으로 지급되는 부분에 대해서는 사내유보가 되는 부분보다 더 낮은 법인세율을 적용해주 는 방식으로 부분통합에 해당된다."],
...
상충관계: 효율 vs 공평(역탄력성 규칙의 역진성)`,
  ...
  },
  {
    ...
    subItems: ["ㄱ. 미래소비로 표시한 현재소비의 상대가격이 하락한다.", "ㄴ. 대체효과에 의해 현재소비가 증가하므로 저축은 감소한다.", "ㄷ. 소득효과에 의해 현재소비가 감소하고 미래소비도 감소한다.", "ㄹ. 실질소득이 감소하므로 효용수준은 감소한다."],
    choices: ["ㄱ, ㄴ, ㄷ", "ㄱ, ㄴ, ㄹ", "ㄱ, ㄷ, ㄹ", "ㄴ, ㄷ, ㄹ", "ㄱ, ㄴ, ㄷ, ㄹ"],
    answer: 3,
...
역진세: t_m<t̄, η<1`,
  ...
  },
  {
    ...
    questionText: `하루 T̄(T̄ ≤ 24)시간을 노동(L)과 여가(ℓ)에 배분하는 근로자의 근로소득은 M, 시간당 임금률은 w이다. 세율 t의 근로소득세가 부과될 경우 다음 설명으로 옳지 않은 것은? (단, 근로소득 이외의 여타 소득은 없다고 가정한다. 그래프의 가로축은 여가이고 세로축은 근로소득이다.)`,
    choices: ["세금 부과 전의 예산선은 M = w(T̄ - ℓ)이다.", "세금 부과 후 예산선의 세로축 절편은 (1 - t)wT̄이다.", "여가가 정상재라면, 노동공급은 증가, 감소 또는 불변일 수 있다.", "여가가 정상재라면, 대체효과가 소득효과보다 클 경우 노동공급은 증가한다.", "여가가 열등재라면, 대체효과와 소득효과 모두 노동공급을 감소시킨다."],
    answer: 1,
...
소득세: 누진적 과세 용이`,
  ...
  },
  {
    ...
    questionText: `X재와 Y재를 소비하는 2인 순수교환경제를 고려하자. 소비자 i의 효용함수는 u_i(X_i, Y_i) = X_i·Y_i이며 (i = 1, 2), 소비자 1의 초기부존은 (ω_X1, ω_Y1) = (0, 20), 소비자 2의 초기부존은 (ω_X2, ω_Y2) = (40, 10)이다. 일반균형배분 ((20, 15), (20, 15))에 도달하기 위하여 초기부존을 재배분한다고 할 때 새로운 초기부존 ((ω_X1, ω_Y1), (ω_X2, ω_Y2))으로 적절한 것은?`,
    choices: ["((10, 16), (30, 14))", "((12, 20), (28, 10))", "((14, 16), (26, 14))", "((16, 18), (24, 12))", "((28, 9), (12, 22))"],
    answer: 4,
...
Diamond-Mirrlees: 분배 고려→수정 역탄력성`,
  ...
  },
  {
    ...
    questionText: `노동(L)과 자본(K)으로 X재와 Y재를 생산하는 어느 경제의 생산가능곡선상의 한 점 (X, Y)에서 한계변환율은 MRT_XY(X, Y) = 1이며, 두 소비자 1과 2의 한계대체율이 MRS_1(X_1, Y_1) = MRS_2(X_2, Y_2) = 2인 상황을 고려하자 (이때 X_1 + X_2 = X, Y_1 + Y_2 = Y이다). 현재 상황에 대한 옳은 설명을 모두 고른 것은?`,
    subItems: ["ㄱ. 이 경제의 현재 상황에서 생산측면의 효율성은 만족된다.", "ㄴ. 이 경제의 현재 상황에서 소비측면의 효율성은 만족된다.", "ㄷ. 이 경제는 현재 상황에서 경제 전체적으로 생산과 소비의 종합적인 파레토 개선이 가능하다."],
...
개방경제: 자본 해외유출→국내 노동에도 귀착`,
  ...
  },
  {
    ...
    questionText: `두 재화 X재와 Y재를 소비하는 소비자의 무차별곡선은 원점에 대해 강볼록하다. 이 소비자의 소득은 60이며, 각 재화의 가격은 p_X = 2, p_Y = 3이라 하자. 이 소비자가 Y재만 5단위를 살 수 있는 상품권을 받을 때와 해당 금액을 현금으로 받을 때의 효용을 비교하고자 한다. 이에 관한 설명으로 옳은 것은? (단, 소비점 (X, Y)에서 이 소비자의 한계대체율은 MRS(X, Y)로 나타내기로 한다.)`,
    choices: ["상품권을 받을 때 효용수준이 반드시 더 높다.", "현금으로 받을 때 효용수준이 반드시 더 높다.", "가격이 달라지면, 상품권을 받을 때 더 높은 효용을 얻을 수 있다.", "MRS(30, 5) = 1이면, 현금으로 받을 때 반드시 더 높은 효용을 얻는다.", "MRS(30, 5) = 0.5이면, 상품권으로 받을 때 반드시 더 높은 효용을 얻는다."],
    answer: 2,
...
교차 시: 지배 관계 없음(지니로는 비교 가능)`,
  ...
  },
  {
    ...
    questionText: `공공재에 대한 두 소비자 1과 2의 수요함수는 각각 P_1 = 50 - Q와 P_2 = 40 - (2/3)Q (단, Q는 공공재 수량)이다. 공공재 한 단위의 생산비는 60으로 일정하다고 하자. 효율적인 공공재 조달을 위한 두 소비자의 부담(P_1과 P_2)은 각각 얼마인가?`,
    choices: ["P_1 = 30, P_2 = 30", "P_1 = 32, P_2 = 28", "P_1 = 35, P_2 = 25", "P_1 = 38, P_2 = 22", "P_1 = 40, P_2 = 20"],
    answer: 3,
...
노직: 절차적 정의
  ...
  },
  {
    ...
    questionText: `좁은 골목에서 서로 마주 보고 있는 두 집에 각각 살고 있는 A와 B가 골목에 가로등을 설치하는 문제를 고려하고 있다. 가로등이 설치되면 두 사람이 얻는 편익은 각각 30으로 알려져 있으며, 가로등의 설치비용은 50이다. 각 사람은 설치에 대해 찬성(Yes) 또는 반대(No)를 선택할 수 있다. 두 사람 모두 찬성하면 설치비용을 반반씩 부담하고, 한 사람만 찬성하면 찬성한 사람만 설치비용을 부담한다. 둘 다 반대하면 가로등은 설치되지 않으며 이때의 편익은 각각 영(0)이다. 이 문제를 전략형게임(strategic game)의 관점에서 분석할 때, 다음 설명 중 옳은 것은?`,
    choices: ["서로 찬성하는 것이 우월전략균형이다.", "서로 찬성하는 것이 우월전략균형은 아니지만 내쉬균형이다.", "무임승차 문제로 인해 이 게임의 내쉬균형은 존재하지 않는다.", "이 문제는 치킨게임이므로 누군가 한 사람만 찬성하는 것이 내쉬균형이다.", "서로 반대하는 것이 유일한 내쉬균형이다."],
    answer: 1,
...
정부실패: 정보부족, 관료이기심, 정치적 영향, 시차`,
  ...
  },
  {
    ...
    questionText: `투표자 A, B, C가 꽁도세(Condorcet) 방식에 따라 다수결로 세 개의 대안 a, b, c 중 하나를 선택하는 문제를 다음 두 가지 사례에 각각 적용한다고 할 때, 다음 설명 중 옳은 것은? (단, 선호조작은 없다고 가정한다.) [사례 1] A: c ≻ b ≻ a, B: b ≻ a ≻ c, C: b ≻ c ≻ a. [사례 2] A: a ≻ c ≻ b, B: b ≻ c ≻ a, C: c ≻ a ≻ b.`,
    choices: ["두 사례 모두에서 투표의 역설 현상이 나타난다.", "사례 1에서는 투표의 역설 현상이 나타나지 않으나, 사례 2에서는 나타난다.", "사례 1에서는 투표의 역설 현상이 나타나지만, 사례 2에서는 나타나지 않는다.", "꽁도세 승자는 사례 1에서는 c이며, 사례 2에서는 a이다.", "꽁도세 승자는 사례 1에서는 b이며, 사례 2에서는 c이다."],
    answer: 4,
...
보조금: 파급효과 교정→중앙정부 역할`,
  ...
  },
  {
    ...
    questionText: `외부성이 있는 시장에서 사적한계편익은 PMB = 150 - Q, 외부한계편익은 EMB = 30 - (1/4)Q이며, 사적한계비용이 PMC = Q이라고 하자. 이 시장의 과소생산 문제를 해결하기 위하여 정부가 생산자에게 단위당 s의 보조금을 지급한다면 s는 얼마인가? (단, Q는 수량이다.)`,
...
양적완화: 비전통적→자산매입→H↑↑`,
  ...
  },
  {
    ...
    questionText: `사회 A, B, C는 모두 두 사람으로 구성되어 있으며 개인 1의 소득(Y_1)이 개인 2의 소득(Y_2)의 4배이다. 사회후생함수가 각각 SW_A = Y_1 + Y_2, SW_B = min{Y_1, Y_2}, SW_C = √(Y_1·Y_2)이라고 할 때, 다음 설명 중 옳지 않은 것은?`,
    choices: ["사회 B의 앳킨슨지수는 사회 A보다 높다.", "사회 C의 앳킨슨지수는 사회 A보다 높다.", "사회 B의 앳킨슨지수는 사회 C보다 높다.", "균등분배 대등소득은 사회 C가 가장 크다.", "앳킨슨지수로 판단할 때 가장 불균등한 분배가 이루어지고 있는 사회는 B이다."],
    answer: 3,
...
→공적보험의 보편적 적용 필요`,
  ...
  },
  {
    ...
    subItems: ["ㄱ. 정책 목표가 해당 현물의 소비 증대라면 현금보조보다 현물보조가 더 효과 적이다.", "ㄴ. 수혜자의 선호를 존중한다면 현물보조보다 현금보조가 더 효과적이다. ㄷ. 현물보조보다 현금보조의 경우 더 높은 행정 및 운영비용이 발생한다. ㄹ. 가격보조가 비효율성을 일으키는 원인은 상대가격구조가 변하기 때문이다.", "ㅁ. 현금보조의 단점은 부정수급과 바람직하지 않은 상품의 오남용이다.", "ㄱ. 정책 목표가 해당 현물의 소비 증대라면 현금보조보다 현물보조가 더 효과 적이다.", "ㄴ. 수혜자의 선호를 존중한다면 현물보조보다 현금보조가 더 효과적이다. ㄷ. 현물보조보다 현금보조의 경우 더 높은 행정 및 운영비용이 발생한다. ㄹ. 가격보조가 비효율성을 일으키는 원인은 상대가격구조가 변하기 때문이다.", "ㅁ. 현금보조의 단점은 부정수급과 바람직하지 않은 상품의 오남용이다."],
...
(세금, 외부성, 세대간 형평)`,
  ...
  },
  {
    ...
    questionText: `부의 소득세제(negative income tax)에 관한 설명으로 옳은 것을 모두 고른 것은? (단, S = B - tE, S: 보조금, B: 기초수당, t: 한계세율, E: 스스로 번 소득)`,
    subItems: ["ㄱ. 재원이 고정되어 있는 상황에서 기초수당을 올리려면 한계세율도 올려야 한다.", "ㄴ. 비범주적(noncategorical) 보조금이므로 수혜대상에 대한 자격심사가 필요 없다.", "ㄷ. 소득의 재분배효과는 한계세율이 낮을수록 커진다.", "ㄹ. 한계세율이 높을수록 근로의욕은 낮아진다.", "ㅁ. 여가가 정상재일 경우 소득효과와 대체효과 모두 노동공급을 감소시키는 방향으로 작용한다."],
...
최소효율규모(MES): LAC 최저점`,
  ...
  },
  {
    ...
    questionText: `어떤 재화의 한계비용은 50이고, 보상수요곡선은 P = 100 - Q이다. 재화의 공급자에게 단위당 20의 조세를 부과하였을 때, 다음 설명으로 옳지 않은 것은? (단, P는 가격, Q는 수량이다.)`,
    choices: ["조세수입은 600이다.", "비효율성계수는 3/4이다.", "소비자잉여의 감소는 800이다.", "과세로 인한 공급자의 판매량 감소는 20이다.", "과세로 조세부담은 소비자에게 전가된다."],
    answer: 3,
...
세율구조: 누진세율(한계세율 체증)`,
  ...
  },
  {
    ...
    subItems: ["ㄱ. 국채가 전액 시중에서 소화될 경우, 이자율이 상승하고 민간투자가 억제되 는 현상을 구축효과라고 한다.", "ㄴ. 통화주의자는 호황기보다 경기 침체기에 구축효과가 더 크게 발생한다고 주장한다.", "ㄷ. 중앙은행이 국채를 인수하면 통화량이 증가하여 인플레이션이 유발된다.", "ㄹ. 중앙은행이 국채를 인수하면 시중에서 소화되는 경우보다 총수요 증대효과 가 더 크다."],
...
시장실패: 무임승차→MB 과소신고→과소공급`,
  ...
  },
  {
    ...
    questionText: `모딜리아니-밀러(Modigliani-Miller)의 제1명제에 관한 설명으로 옳은 것을 모두 고른 것은?`,
    subItems: ["ㄱ. 기업의 가치를 극대화하는 최적 자본구조의 존재를 입증한 것이다.", "ㄴ. 기업의 수익에 조세를 부과하지 않는 것을 가정한다.", "ㄷ. 경영자와 주주 간에 주인-대리인 문제가 있다고 가정한다.", "ㄹ. 모든 투자자와 경영자가 같은 정보를 가지고 있음을 가정한다.", "ㅁ. 기업의 파산과 관련한 비용은 발생하지 않는다.", "ㄱ. 기업의 가치를 극대화하는 최적 자본구조의 존재를 입증한 것이다.", "ㄴ. 기업의 수익에 조세를 부과하지 않는 것을 가정한다.", "ㄷ. 경영자와 주주 간에 주인-대리인 문제가 있다고 가정한다.", "ㄹ. 모든 투자자와 경영자가 같은 정보를 가지고 있음을 가정한다.", "ㅁ. 기업의 파산과 관련한 비용은 발생하지 않는다."],
...
고전학파(LM수직): r↑↑→완전구축→재정무효`,
  ...
  },
  {
    ...
    subItems: ["ㄱ. 여가가 정상재이고 소득효과가 대체효과보다 작으면 노동공급곡선은 후방 굴절형이다.", "ㄴ. 여가가 정상재이고 비례소득세 부과로 대체효과가 소득효과보다 크다면 노 동공급은 늘어난다.", "ㄷ. 여가가 열등재일 때 중립세로 부과하면 소득효과만 존재한다."],
    choices: ["ㄱ", "ㄷ", "ㄱ, ㄴ", "ㄴ, ㄷ", "ㄱ, ㄴ, ㄷ"],
    answer: 3,
...
여가 대체재→낮은 세율`,
  ...
  },
  {
    ...
    questionText: `개인 A와 B로 구성된 경제에 X재가 1000단위 존재하며, 이 재화에 대한 효용함수는 각각 U_A = 3√(X_A), U_B = √(X_B)이다. 이 사회의 사회후생함수를 W = min{U_A, U_B}로 가정한다. 다음 중 옳지 않은 것은? (단, X_i > 0 (i = A, B)는 개인 i의 X재 소비량이다.)`,
    choices: ["X재가 사용재인 경우 사회후생의 극댓값은 30이다.", "롤즈적 사회후생함수를 상정하고 있다.", "X재가 순수공공재인 경우 A와 B는 같은 양을 소비한다.", "X재가 순수공공재인 경우 사회후생수준은 A의 효용에 의해 결정된다.", "X재가 사용재인 경우 사회후생의 극댓값은 순수공공재인 경우보다 작다."],
    answer: 2,
...
교차 시: 지니 비교 가능, 로렌츠 지배 불가`,
  ...
  },
  {
    ...
    questionText: `도농복합도시 A시에는 도시와 농촌지역에 각각 5명의 주민이 거주하고, 시정부는 소방서비스를 제공하고 있다. 도시지역 주민의 개별수요함수는 P = 20 - Q이고, 농촌지역 주민의 개별수요함수는 P = 15 - 2Q이다. 공공재인 소방서비스의 한계비용이 85일 때, 사회적으로 바람직한 서비스 수준은? (단, P는 가격, Q는 서비스의 양이다.)`,
    choices: ["2", "4", "5", "6", "8"],
    answer: 3,
...
지니: 로렌츠 기반, 특정SWF 불필요`,
  ...
  },
  {
    ...
    questionText: `A와 B 두 명으로 구성된 사회에서 개인의 효용을 각각 U_A와 U_B, 사회후생을 W라고 할 때, 다음 중 옳지 않은 것은?`,
    choices: ["평등주의적 사회후생함수는 많은 효용을 가진 사람에게는 낮은 가중치를, 적은 효용을 가진 사람에게는 높은 가중치를 준다.", "공리주의적 사회후생함수는 모든 구성원에게 동일한 가중치를 평등하게 부여한다.", "롤즈적 사회후생함수는 W = min{U_A, U_B}로 나타낼 수 있다.", "사회후생함수가 W = U_A + 2U_B일 경우, B의 효용을 A의 효용보다 2배 더 중요시한다.", "공리주의적 사회후생함수에 의하면 소득의 한계효용이 감소할 때 사회후생의 극대화를 위해서는 각 개인 소득의 한계효용이 서로 달라야 한다."],
    answer: 4,
...
현실: 보조금은 해당 분야 지출 더 증가(끈끈이 효과)`,
  ...
  },
  {
    ...
    questionText: `다음은 재화 X의 소비에 대한 사적한계편익(PMB), 생산의 사회적 한계비용(SMC), 생산에 따른 한계 외부피해(MD)이다. PMB = 600 - 4Q, SMC = 6Q, MD = 2Q. 사회적 최적 생산량을 위한 피구세의 크기는? (단, Q는 생산량이다.)`,
...
정보공개→의회 감시 강화`,
  ...
  },
  {
    ...
    subItems: ["ㄱ. 역선택으로 인한 시장실패 치유 ㄴ. 정부조세수입 확충", "ㄷ. 온정적 간섭 ㄹ. 소득재분배 수단", "ㄱ. 역선택으로 인한 시장실패 치유 ㄴ. 정부조세수입 확충", "ㄷ. 온정적 간섭 ㄹ. 소득재분배 수단"],
...
NDC(명목확정기여) 방식 논의`,
  ...
  },
  {
    ...
    subItems: ["ㄱ. 직접세는 법적 납세의무자와 담세자가 일치한다.", "ㄴ. 간접세는 직접세에 비해 조세저항이 작고 징세비용이 적게 소요된다.", "ㄷ. 수직적 공평 측면에서 간접세가 직접세보다 우월하다.", "ㄹ. 직접세이면서 물세(in rem tax)의 예는 재산세와 증여세이다.", "ㄱ. 직접세는 법적 납세의무자와 담세자가 일치한다.", "ㄴ. 간접세는 직접세에 비해 조세저항이 작고 징세비용이 적게 소요된다.", "ㄷ. 수직적 공평 측면에서 간접세가 직접세보다 우월하다.", "ㄹ. 직접세이면서 물세(in rem tax)의 예는 재산세와 증여세이다."],
...
따라서 옳은 것은 ㄱ, ㄴ → 정답 ①`,
  ...
  },
  {
    ...
    questionText: `조세부담액(T)과 소득(Y) 간에 T = -300 + 0.3Y와 같은 관계가 성립하는 경우, 옳지 않은 것은? (단, Y는 0보다 크다.)`,
    choices: ["소득세가 선형누진세이다.", "소득 규모에 관계없이 한계세율이 일정하다.", "소득 증가 시 평균세율이 증가한다.", "평균세율은 한계세율보다 항상 높다.", "세수탄력성이 1보다 큰 값을 갖는다."],
    answer: 4,
...
⑤ (옳음): 세수탄력성 = (dT/dY)·(Y/T) = a·Y/(aY+b). b<0이므로 aY+b < aY → a·Y/(aY+b) > 1. 세수탄력성 > 1.`,
  ...
  },
  {
    ...
    subItems: ["ㄱ. 납세자가 절대위험기피도 체감의 특성을 가진다고 가정한다.", "ㄴ. 감사받을 확률의 증가와 벌금률의 증가가 탈루소득을 줄인다는 결과가 도출 되었다.", "ㄷ. 세율 상승의 소득효과와 대체효과가 같은 방향으로 작용하므로 탈루소득을 더 크게 만든다.", "ㄹ. 샌드모는 세율을 합리적인 수준으로 유지하고 감사받을 확률과 벌금률 조정을 탈세 방지의 수단으로 활용하는 것이 바람직하다고 주장한다."],
...
⑤ (틀림): 독점 시장에서 수요의 가격탄력성이 작을수록 가격을 더 올릴 수 있으므로 소비자 부담이 더 커짐.`,
  ...
  },
  {
    ...
    questionText: `수요함수가 Q_d = 40 - (1/2)P이고 공급함수가 Q_s = -20 + P인 완전경쟁시장에서, 정부가 단위당 12의 물품세를 생산자에게 부과할 때, 생산자와 소비자의 단위당 부담은?`,
    choices: ["생산자 10, 소비자 2", "생산자 8, 소비자 4", "생산자 6, 소비자 6", "생산자 4, 소비자 8", "생산자 2, 소비자 10"],
    answer: 4,
...
⑤ (틀림 → 정답): 완전통합 국가는 극히 드물며, 대부분은 부분적 이중과세 완화만 시행. '대부분의 국가가 완전통합을 이루었다'는 사실과 반대.`,
  ...
  },
  {
    ...
    subItems: ["ㄱ. 조세지출을 통한 민간부문의 특정 행위 촉진이 바람직해야 한다.", "ㄴ. 조세지출은 항상 효율성을 우선적으로 충족해야 한다.", "ㄷ. 민간부문을 대신하여 정부가 조세지출로 관여하는 이유가 명확해야 한다.", "ㄹ. 민간부문의 특정 행위 촉진 방법으로 조세지출 사용이 최선인가를 검토해야 한다.", "ㅁ. 조세지출 규모는 매년 일정 비율로 늘어나야 한다."],
...
⑤ '효율적 배분이 경쟁균형보다 파레토열등하다'는 명백히 틀림.`,
  ...
  },
  {
    ...
    questionText: `두 재화 x와 y를 소비하는 두 소비자로 구성된 순수교환경제에서, 소비자 1과 2의 효용함수는 각각 u_1(x_1, y_1) = x_1·y_1과 u_2(x_2, y_2) = x_2·y_2²이며, 초기부존은 각각 (3, 1)과 (0, 3)이다. 다음 배분 ((x_1, y_1), (x_2, y_2)) 중 파레토 효율적 배분은?`,
    choices: ["((1.5, 1), (1.5, 2))", "((1.5, 1), (1.5, 3))", "((1.5, 2), (1.5, 2))", "((2, 2), (1, 2))", "((2, 2), (2, 2))"],
    answer: 4,
...
실제 시험 답은 주어진 수치 대입 후 계약곡선 조건을 만족하는 보기를 선택한다.`,
  ...
  },
  {
    ...
    questionText: `어느 독점기업이 직면하는 수요가 P = 120 - (1/2)Q이고, 한계비용이 MC = Q라 하자. 이 독점기업의 생산 활동으로 인해 발생하는 사회후생손실(social welfare loss)에 관한 설명으로 옳은 것을 모두 고른 것은? (단, Q는 생산량이다.)`,
    subItems: ["ㄱ. 이 독점기업의 영업을 폐지하면, 영업을 계속하는 경우보다 사회후생이 증가한다.", "ㄴ. 정부가 P = 100 수준에서 최고가격제를 실시하면, 사회후생손실은 감소한다.", "ㄷ. 정부가 P = 80 수준에서 최고가격제를 실시하면, 사회후생손실은 0으로 감소한다.", "ㄹ. 정부가 P = 80 수준에서 최고가격제를 실시하면, 사회후생손실은 300만큼 감소한다."],
...
⑤ 규모의 불경제 하에서는 자연독점 발생하지 않음 (규모의 경제가 필요)`,
  ...
  },
  {
    ...
    subItems: ["ㄱ. 혼잡한 무료 국도는 순수공공재이다.", "ㄴ. 대가를 지불하지 않아도 소비할 수 있는 재화이다.", "ㄷ. 중앙정부에서 무료로 제공하는 볼펜은 순수공공재이다.", "ㄹ. 지방정부에서 여름에 무료로 제공하는 얼음 생수는 순수공공재이다."],
...
정답: ㄴ`,
  ...
  },
  {
    ...
    questionText: `어느 경제에서 공공재에 대한 개별수요가 서로 다른 두 그룹이 있으며 그룹 1은 6명, 그룹 2는 4명으로 구성되어 있다. 그룹 1에 속한 각 소비자의 공공재에 대한 개별수요는 P_1 = 30 - (1/6)Q이며, 그룹 2에 속한 각 소비자의 공공재에 대한 개별수요는 P_2 = 60 - (1/2)Q이다. 공공재 생산의 평균비용이 모든 생산량 Q에서 AC = 240으로 일정하다고 할 때, 효율적 공공재 공급을 위한 각 그룹별 개별소비자의 부담은 얼마인가?`,
    choices: ["P_1 = 5, P_2 = 10", "P_1 = 10, P_2 = 20", "P_1 = 15, P_2 = 20", "P_1 = 20, P_2 = 30", "P_1 = 20, P_2 = 40"],
    answer: 3,
...
실제 시험에서는 공식 MC와 주어진 정수 조합 중 Σ(개별부담) = MC를 만족하는 선택지를 정답으로 한다.`,
  ...
  },
  {
    ...
    subItems: ["ㄱ. 꽁도세(Condorcet) 승자는 항상 존재한다.", "ㄴ. 과반수투표제 승자가 존재하면, 꽁도세 승자와 반드시 일치한다.", "ㄷ. 최다득표제 승자가 존재하면, 꽁도세 승자와 반드시 일치한다.", "ㄹ. 꽁도세 승자가 존재한다면, 항상 유일하다.", "ㄱ. 꽁도세(Condorcet) 승자는 항상 존재한다.", "ㄴ. 과반수투표제 승자가 존재하면, 꽁도세 승자와 반드시 일치한다.", "ㄷ. 최다득표제 승자가 존재하면, 꽁도세 승자와 반드시 일치한다.", "ㄹ. 꽁도세 승자가 존재한다면, 항상 유일하다."],
    choices: ["ㄱ, ㄴ", "ㄱ, ㄷ", "ㄴ, ㄷ", "ㄴ, ㄹ", "ㄴ, ㄷ, ㄹ"],
    answer: 4,
...
정답: ㄴ, ㄹ`,
  ...
  },
  {
    ...
    questionText: `10명의 투표자 중 A 유형은 3명, B 유형은 3명, C 유형은 4명이며, 이들은 네 개의 대안 a, b, c, d를 놓고 선택하고자 한다. 각 유형의 대안에 대한 선호는 다음과 같다고 하자. ○ A 유형[3명]: a ≻ b ≻ c ≻ d, ○ B 유형[3명]: a ≻ b ≻ d ≻ c, ○ C 유형[4명]: b ≻ c ≻ d ≻ a. 꽁도세(Condorcet) 방식과 보다(Borda) 투표제로 승자를 각각 결정할 때, 그 결과로 옳은 것은? (단, 선호조작은 없다고 가정한다.)`,
    choices: ["꽁도세 승자와 보다 승자는 모두 a이다.", "꽁도세 승자와 보다 승자는 모두 b이다.", "꽁도세 승자는 a, 보다 승자는 b이다.", "꽁도세 승자는 b, 보다 승자는 a이다.", "꽁도세 승자는 존재하지 않지만, 보다 승자는 a이다."],
    answer: 3,
...
정답: ⑤`,
  ...
  },
  {
    ...
    questionText: `어떤 공장이 생산 활동을 하면서 오염 물질을 배출한다. 이로 인한 피해자의 한계피해는 MD = (1/2)Q이며 피해자는 별도의 편익을 얻지 않는다. 공장의 한계편익은 MB = 120 - Q이며, 한계비용은 MC = 0이다. 당사자 간 협상은 자유롭게 이루어질 수 있으며 거래비용은 0이다. 오염배출권리가 공장에 있을 경우, 사회적으로 효율적인 생산량에 도달하도록 협상이 타결되기 위해 피해자가 공장에 제공해야 하는 최소 금액은 얼마인가? (단, Q는 생산량이다.)`,
